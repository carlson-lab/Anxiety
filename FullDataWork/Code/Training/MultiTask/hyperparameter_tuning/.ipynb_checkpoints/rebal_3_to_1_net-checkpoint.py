...
results_file = results_path + "500_fixed_bootstrap_321_net_{}_results.pkl".format(fold)
...
circle_plot(rec_3d,anxInfo["area"],freqs=np.arange(56),freq_ticks=np.arange(0,56,5),
            min_max_quantiles=(0.85,0.9999),fn=plots_path + "500_fixed_bootstrap_321_network_net_1_30_component_kf_fold_{}_electome.png".format(fold))

circle_plot(rec_3d_2,anxInfo["area"],freqs=np.arange(56),freq_ticks=np.arange(0,56,5),
            min_max_quantiles=(0.85,0.9999),fn=plots_path + "500_fixed_bootstrap_321_network_net_2_30_component_kf_fold_{}_electome.png".format(fold))

circle_plot(rec_3d_3,anxInfo["area"],freqs=np.arange(56),freq_ticks=np.arange(0,56,5),
            min_max_quantiles=(0.85,0.9999),fn=plots_path + "500_fixed_bootstrap_321_network_net_3_30_component_kf_fold_{}_electome.png".format(fold))
...
umc_dt.makeUpperTriangularPlot_pow_coh_gc(net_1_recon_contribution.reshape(1,-1),anxInfo["area"],anxInfo["powerFeatures"],
                                          ...
                                          saveFile=plots_path + "500_fixed_bootstrap_321_network_net_1_30_component_kf_fold_{}_up-tri.png".format(fold))
umc_dt.makeUpperTriangularPlot_pow_coh_gc(net_2_recon_contribution.reshape(1,-1),anxInfo["area"],anxInfo["powerFeatures"],
                                          anxInfo["cohFeatures"],anxInfo["gcFeatures"],
                                          saveFile=plots_path + "500_fixed_bootstrap_321_network_net_2_30_component_kf_fold_{}_up-tri.png".format(fold))
umc_dt.makeUpperTriangularPlot_pow_coh_gc(net_3_recon_contribution.reshape(1,-1),anxInfo["area"],anxInfo["powerFeatures"],
                                          anxInfo["cohFeatures"],anxInfo["gcFeatures"],
                                          saveFile=plots_path + "500_fixed_bootstrap_321_network_net_3_30_component_kf_fold_{}_up-tri.png".format(fold))
