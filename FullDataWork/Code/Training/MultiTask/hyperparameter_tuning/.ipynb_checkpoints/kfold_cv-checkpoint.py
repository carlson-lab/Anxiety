...
saved_model_name = "final_fixed_30_net_kf_fold_{}_model.pt".format(fold)

results_path = "/hpc/home/mk423/Anxiety/FullDataWork/Validations/"
results_file = results_path + "final_fixed_30_net_kf_fold_{}_results.pkl".format(fold)
...
circle_plot(rec_3d,anxInfo["area"],freqs=np.arange(56),freq_ticks=np.arange(0,56,5),
            min_max_quantiles=(0.85,0.9999),fn=plots_path + "final_fixed_30_net_kf_fold_{}_electome.png".format(fold))
...
umc_dt.makeUpperTriangularPlot_pow_coh_gc(recon_contribution.reshape(1,-1),anxInfo["area"],anxInfo["powerFeatures"],
                                          ...
                                          saveFile=plots_path + "final_fixed_30_net_kf_fold_{}_uptri.png".format(fold))
