...
saved_model_path = "/work/mk423/Anxiety/n_net_models/"
saved_model_name = "{}_net_cv_anx.pt".format(N_COMPONENTS)
...
results_file = results_path + "{}_net_val_results.pkl".format(N_COMPONENTS)
...
epm_val_auc = model.score(X_val,
                          ...
                          y_mouse_val,
                          return_dict=True)
epm_val_mse = np.mean((X_val - model.reconstruct(X_val))**2)
